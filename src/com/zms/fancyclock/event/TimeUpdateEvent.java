package com.zms.fancyclock.event;

/**
 * To notify time's updating . Created by lypeer on 16/9/13.
 */
public class TimeUpdateEvent extends EmptyEvent {
	...
	public TimeUpdateEvent(int hourTenDigits, int hourSingleDigits,
			int minTenDigits, int minSingleDigits, int secTenDigits,
			int secSingleDigits) {
