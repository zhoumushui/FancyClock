package com.zms.fancyclock.service;
 ...
 * <p/>
 * I am trying to reduce the time to visit system's time , because it needs so
 * much time . So I choose the way in this class to make a clock .
 * <p/>
...
public class LyClockService extends Service {
	...
	private void sendEvent() {
		EventBus.getDefault().post(
				new TimeUpdateEvent(mHourTenDigits, mHourSingleDigits,
						mMinTenDigits, mMinSingleDigits, mSecTenDigits,
						mSecSingleDigits));
	}
